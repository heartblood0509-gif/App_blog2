      ...
      <Section id="mac" number="03" title="Mac에서 업데이트하기">
        ...
        <ol>
          ...
          <li>
            ...
            목록이 있어요. 그중 <strong>내 맥 칩에 맞는</strong> <Code>.dmg</Code>
            파일을 받습니다. — Apple Silicon(M1~M4)이면{" "}
            <Code>Blog-Pick-Mac-AppleSilicon-….dmg</Code>, Intel이면{" "}
            <Code>Blog-Pick-Mac-Intel-….dmg</Code>. (내 칩 확인: 🍎 →
            「이 Mac에 관하여」 → “칩/프로세서”. 처음 설치 때와 같은 칩 파일을
            받으면 돼요.)
          </li>
        </ol>
        ...
        <ol>
          <li>
            다운로드된 파일(예:{" "}
            <Code>Blog-Pick-Mac-AppleSilicon-0.3.3.dmg</Code>)을{" "}
